...
export default function ChatPage() {
    ...
    // Load pesan ketika contact berubah
    useEffect(() => {
    ...
    // Empty state - belum ada chat dipilih
    if (!selectedContact) {
        return (
            <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-950 h-full min-h-[500px] rounded-xl">
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-2rem)] bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            {/* Header Chat */}
            <header className="flex items-center gap-3 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 sticky top-0 z-10">
            ...
            {/* Area Pesan */}
            <main className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50 dark:bg-gray-950">
                {loadingMessages ? (
